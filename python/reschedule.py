...
async def _perform_notifications(app: Application, update_df: bool) -> None:
    ...
    for idx,notification in Notifications.iterate_over_notifications_to_plan():
        ...
        Groups.send_to_all_superadmin_groups(app, superadmin_group_text, ParseMode.MARKDOWN, notification.send_picture, notification.send_document)
    ...
    for idx,notification in Notifications.iterate_over_planned_notifications():
        Users.send_notification_to_all_users(
            app, notification.text_markdown, ParseMode.MARKDOWN, notification.send_picture, notification.send_document, notification.state, notification.condition
        )
        if notification.state == "":
            Groups.send_to_all_normal_groups(app, notification.text_markdown, ParseMode.MARKDOWN, notification.send_picture, notification.send_document)
        admin_group_text = \
        ...
        Groups.send_to_all_admin_groups(app, admin_group_text, ParseMode.MARKDOWN, notification.send_picture, notification.send_document)
